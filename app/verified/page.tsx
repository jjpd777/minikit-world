              ...
              <div className="flex gap-4 justify-between w-full">
                ...
                {!audioUrl && (
                  <button
                    ...
                    className="flex-1 px-9 py-2 bg-white text-purple-600 border border-purple-600 rounded-lg hover:bg-purple-Li50 transition-colors flex items-center justify-center gap-3 min-w-[113px] disabled:opacity-50"
                  >
