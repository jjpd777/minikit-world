...
export async function POST(request: NextRequest) {
  try {
    ...
    const religionPrompts = {
      ...
      islamic: 'Write a short Islamic prayer (approximately 100 words) that begins with "Bismillah ir-Rahman ir-Raheem" and reflects the given intentions. The prayer should incorporate relevant Quranic verses or Hadith naturally. The verse should be seamlessly connected to the prayer\'s theme. The prayer should be warm and uplifting, respecting Islamic traditions.',
      ...
      atheist: 'Write a short ATHEIST reflection (approximately 100 words) that begins with an emotionally impactful opening line reflecting the given intentions. The reflection should incorporate relevant philosophical or scientific wisdom. DO NOT MENTION GOD, KEEP IT ATHEIST FOR THE SAKE OF PROVING A POINT. Just reply with the prayer, provide no interactive text',
