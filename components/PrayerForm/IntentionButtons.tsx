    ...
    <div className="w-full max-w-2xl mx-auto mb-4 space-y-6">
      <div>
        <button 
          ...
          className="text-xl font-semibold text-black mb-3 flex items-center gap-2"
        >
          Prayer For {showPrayerFor ? '▼' : '▶'}
        </button>
        {showPrayerFor && (
            ...
            {currentIntentions.map((intention, index) => (
              <button
                ...
                className="px-3 py-2 bg-purple-500/20 hover:bg-purple-500/30 
                         rounded-lg transition-colors text-sm text-purple-900
      ...
      <div>
        <button 
          ...
          className="text-xl font-semibold text-black mb-3 flex items-center gap-2"
        >
          Prayer Intentions {showIntentions ? '▼' : '▶'}
        </button>
        {showIntentions && (
